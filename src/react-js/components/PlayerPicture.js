                ...
                return (
                    <div className="player__info">
                        <div className="col-md-12 text-center">
                            ...
                            {
                                (this.props.store.playerPictureApi2Response.player !== null && this.props.store.playerPictureApi2Response.player[0].strBirthLocation !== "" && this.props.store.playerPictureApi2Response.player[0].strBirthLocation !== null) ?
                            ...
                            {
                                (this.props.store.playerPictureApi2Response.player !== null && this.props.store.playerPictureApi2Response.player[0].strHeight !== "" && this.props.store.playerPictureApi2Response.player[0].strHeight !== null) ?
                                <div className="info__block">
                                    <h4>Height</h4>
                            ...
                            {
                                (this.props.store.playerPictureApi2Response.player !== null && this.props.store.playerPictureApi2Response.player[0].strWeight !== "" && this.props.store.playerPictureApi2Response.player[0].strWeight !== null) ?
                                <div className="info__block">
                                    <h4>Weight</h4>
                            ...
                            {
                                (this.props.store.playerPictureApi2Response.player !== null && this.props.store.playerPictureApi2Response.player[0].dateSigned !== null) ? 
                                <div className="info__block">
                             ...
                             {
                                (this.props.store.playerPictureApi2Response.player !== null && this.props.store.playerPictureApi2Response.player[0].strSigning !== null && this.props.store.playerPictureApi2Response.player[0].strSigning !== "") ? 
                                <div className="info__block">
                                    <h4>Transfer fee</h4>
                            ...
                            {
                                (this.props.store.playerPictureApi2Response.player !== null && this.props.store.playerPictureApi2Response.player[0].strDescriptionEN !== null) ? 
                                    <div className="info__block">
                                        <h4>Bio</h4>
